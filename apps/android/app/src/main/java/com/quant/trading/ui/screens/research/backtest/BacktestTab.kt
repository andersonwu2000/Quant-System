        ...
        QuantCard {
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.backtest_strategy)) },
                    singleLine = true,
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.backtest_start_date)) },
                        singleLine = true,
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.backtest_end_date)) },
                        singleLine = true,
                        modifier = Modifier.weight(1f),
                    )
                }
