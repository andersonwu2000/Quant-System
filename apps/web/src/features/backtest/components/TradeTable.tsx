    ...
    <Card className="p-5">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs">
          ...
          <tbody>
            {trades.map((tr, i) => (
              <tr key={`${tr.date}-${tr.symbol}-${tr.side}-${i}`} className="border-b border-slate-100 dark:border-surface-light/50 hover:bg-slate-50 dark:hover:bg-surface-light/30 transition-colors">
