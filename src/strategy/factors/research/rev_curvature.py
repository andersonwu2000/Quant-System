"""Auto-generated research factor: rev_curvature

12M quadratic curvature
Academic basis: Trend acceleration
...
def compute_rev_curvature(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_curvature for all symbols at as_of date."""
    results = {}
