"""Auto-generated research factor: rev_zscore_36m

36 月 z-score（longer window, more stable）
...
def compute_rev_zscore_36m(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_zscore_36m for all symbols at as_of date."""
    results = {}
