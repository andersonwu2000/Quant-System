"""Auto-generated research factor: rev_accel_6m_18m
...
def compute_rev_accel_6m_18m(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_accel_6m_18m for all symbols at as_of date."""
    results = {}
