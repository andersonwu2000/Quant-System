"""Auto-generated research factor: rev_accel_x_yoy
...
def compute_rev_accel_x_yoy(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_accel_x_yoy for all symbols at as_of date."""
    results = {}
