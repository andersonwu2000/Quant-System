"""Auto-generated research factor: rev_exp_zscore

exp-weighted z-score
Academic basis: Recency-weighted SUE
...
def compute_rev_exp_zscore(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_exp_zscore for all symbols at as_of date."""
    results = {}
