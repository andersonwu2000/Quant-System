"""Auto-generated research factor: rev_zscore_x_newhigh
...
def compute_rev_zscore_x_newhigh(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_zscore_x_newhigh for all symbols at as_of date."""
    results = {}
