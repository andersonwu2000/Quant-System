"""Auto-generated research factor: rev_zscore_18m

18 月 z-score（middle ground）
...
def compute_rev_zscore_18m(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_zscore_18m for all symbols at as_of date."""
    results = {}
    for sym in symbols:
        try:
