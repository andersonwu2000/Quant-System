"""Auto-generated research factor: rev_diff_accel

level difference vs ratio
Academic basis: Absolute momentum
...
def compute_rev_diff_accel(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_diff_accel for all symbols at as_of date."""
    results = {}
