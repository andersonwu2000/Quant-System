"""Auto-generated research factor: rev_log_accel

log(3M/12M) ratio
Academic basis: Log momentum
...
def compute_rev_log_accel(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_log_accel for all symbols at as_of date."""
    results = {}
