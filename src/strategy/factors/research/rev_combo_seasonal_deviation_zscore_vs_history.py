"""Auto-generated research factor: rev_combo_seasonal_deviation_zscore_vs_history

auto combo: rev_seasonal_deviation × rev_zscore_vs_history
...
def compute_rev_combo_seasonal_deviation_zscore_vs_history(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_combo_seasonal_deviation_zscore_vs_history for all symbols at as_of date."""
    results = {}
