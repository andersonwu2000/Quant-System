"""Auto-generated research factor: rev_accel_6m_9m
...
def compute_rev_accel_6m_9m(symbols: list[str], as_of: pd.Timestamp) -> dict[str, float]:
    """Compute rev_accel_6m_9m for all symbols at as_of date."""
    results = {}
