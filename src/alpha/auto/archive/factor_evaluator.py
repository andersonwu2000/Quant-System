"""[ARCHIVED] Legacy FactorEvaluator — superseded by scripts/autoresearch/evaluate.py.

Archived by AP-2 cleanup (2026-04-02). Zero callers verified by AP audit.
The autoresearch evaluate.py is now the single evaluation standard.
"""
...
class FactorEvaluator:
    ...
    def _check_correlation(self, factor: pd.DataFrame, fwd_20: pd.DataFrame) -> tuple[float, str]:
        """Check max correlation with existing factors using IC series."""
