# Auto-Discovery: rev_accel_x_operating_margin

**日期**: 2026-03-27T10:40:49.211069
**方向**: revenue_quality_interaction
**假說**: 營收加速中且營業利益率穩定/改善
**學術依據**: Operating leverage effect
...
- **deflated_sharpe** (0.901): 多重測試校正後信心不足（測了 90 個因子）。這是統計保守，不代表因子無效
...
| 因子 | ICIR | 說明 |
|------|:----:|------|
| **rev_accel_x_operating_margin** | **+0.859** | **本次發現** |
